...
function showMessage(message, type = 'info') {
  ...
  if (messageEl) {
    ...
    messageEl.style.color = type === 'success' ? 'green' : type === 'error' ? 'red' : '#3b82f6';
    messageEl.style.backgroundColor = type === 'success' ? '#e6ffe6' : type === 'error' ? '#ffe6e6' : '#f0f4ff';
    messageEl.style.border = `1px solid ${type === 'success' ? 'green' : type === 'error' ? 'red' : '#3b82f6'}`;
